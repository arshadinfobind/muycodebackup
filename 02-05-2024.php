...
if (isset($_GET["submit"])) {
    ...
    $payment_ref = isset($_GET["payment_ref"]) ? $_GET["payment_ref"] : null;
...
if ($email != null) {
    // $query .= " AND parameter LIKE '%$email%'";
...
if ($transaction_id != null) {
    ...
    // $query .= " AND parameter LIKE '%$transaction_id%'";
}
...
$query .= " ORDER BY entry_time DESC";
    ...
    // echo "Hello Everyone";
    $limit2 = 2;
    $query = "SELECT * FROM log_request ORDER BY entry_time DESC LIMIT $limit2";
