...
<div class="compare-database-block">
    ...
    <?php foreach ($tables as $tableName => $data) { ?>
        <tr class="data">
            ...
            //     echo $blockType;
                if($blockType == "fArray" && $blockType != "sArray")
                $database_name = DATABASE_NAME;
                else
                $database_name = DATABASE_NAME_SECONDARY;
            ...
            ?>
                        <b>rows - <?php echo $result->num_rows; ?></b><br>
                          <?php  foreach ($additionalTableInfo[$tableName][$blockType] as $paramKey => $paramValue) {
